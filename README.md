...
- **Full-Stack Engineering** — Node.js, Express 5, React, JavaScript, MongoDB, Python
...
`Node.js` `Express` `React` `JavaScript` `MongoDB` `Python` `Django` `Tailwind CSS` `Google Gemini API` `Telegram Bot API` `Figma` `Redis`
